...
#
# Script generated by Vivado on Sat Jun 20 19:58:36 CEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_cvqkd_bob_dsp_top.sh
...
#
# Usage        : tb_cvqkd_bob_dsp_top.sh
#                tb_cvqkd_bob_dsp_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_cvqkd_bob_dsp_top.sh [-rerun]
#                tb_cvqkd_bob_dsp_top.sh [-reset_run]
#                tb_cvqkd_bob_dsp_top.sh [-clean]
#                tb_cvqkd_bob_dsp_top.sh [-reset_log]
#                tb_cvqkd_bob_dsp_top.sh [-help]
#
...
export RDI_DATADIR="/home/drg/AMD/Xilin/${SIM_VER_XSIM}/data"
...
# script info
echo -e "tb_cvqkd_bob_dsp_top.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_cvqkd_bob_dsp_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L c_reg_fd_v12_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L mult_gen_v12_0_24 -L axi_utils_v2_0_11 -L cordic_v6_0_25 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_cvqkd_bob_dsp_top xil_defaultlib.tb_cvqkd_bob_dsp_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_cvqkd_bob_dsp_top -key {Behavioral:sim_1:Functional:tb_cvqkd_bob_dsp_top} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/drg/AMD/Xilin/${SIM_VER_XSIM}/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_cvqkd_bob_dsp_top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_cvqkd_bob_dsp_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_cvqkd_bob_dsp_top.sh [-help]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-step]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-lib_map_path]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-rerun]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-reset_run]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-clean]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-reset_log]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-keep_index]\n\
Usage: tb_cvqkd_bob_dsp_top.sh [-noclean_files]\n\n\
