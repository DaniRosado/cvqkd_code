...
module alice_post_processing_core #(
    ...
    // --- Interfaz de Síndrome Objetivo (Desde Wrapper AXI-Lite) ---
    input  logic         target_syn_we,
    input  logic [5:0]   target_syn_addr,
    input  logic [Z-1:0] target_syn_data,

    // --- Interfaz de Extracción de Clave Reconciliada (Hacia Wrapper) ---
