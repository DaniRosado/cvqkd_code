# ==============================================================================
# Script de Creación del Block Design (BD) para el Subsistema Alice CV-QKD
# Dispositivo: xc7z020clg400-1 (PYNQ-Z2)
# ==============================================================================

# 1. Abrir proyecto si no está ya abierto
set cur_proj [get_projects -quiet]
if { $cur_proj eq "" } {
    open_project /home/drg/VivadoProyects/cvqkd_alice/cvqkd_alice.xpr
}

# 2. Configurar repositorio de IPs customizadas de Alice
set_property ip_repo_paths [list /home/drg/TFG/cvqkd_code/IPs_alice] [current_project]
update_ip_catalog -rebuild

# 3. Crear o resetear el Block Design design_1
...
# 4. Crear puertos de interfaz externos para Zynq PS (DDR y FIXED_IO)
set DDR [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl:1.0 DDR ]
set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]

# 5. Instanciar y configurar Processing System 7 (PYNQ-Z2)
...
# 6. Instanciar AXI DMAs en modo Simple Transfer (Sólo MM2S para Alice)
# DMA 0: Transmisión de coordenadas X (52.2 KB por bloque)
...
# DMA 1: Transmisión del mensaje público m de Bob (104.4 KB por bloque)
...
# 7. Instanciar SmartConnect (GP0: 1 SI -> 3 MI)
...
# 8. Instanciar Processor System Reset
set rst_ps7_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_100M ]

# 9. Instanciar AXI Interconnect para acceso a DDR por HP0 (2 SI -> 1 MI)
...
# 10. Instanciar Concat para interrupciones DMA (2 entradas -> IRQ_F2P)
set xlconcat_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 xlconcat_0 ]
set_property CONFIG.NUM_PORTS {2} $xlconcat_0

# 11. Instanciar el Acelerador Hardware de Alice
set cvqkd_alice_axi_wrapper_0 [ create_bd_cell -type ip -vlnv user.org:user:cvqkd_alice_axi_wrapper:1.0 cvqkd_alice_axi_wrapper_0 ]
set_property CONFIG.C_S_AXI_ADDR_WIDTH {13} $cvqkd_alice_axi_wrapper_0

# 12. Conexiones AXI de Memoria y Control (Interfaces)
# Conexión externa Zynq
connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

# GP0 -> SmartConnect -> Periféricos AXI-Lite
...
connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins cvqkd_alice_axi_wrapper_0/s_axi]

# DMAs -> Acelerador (AXI-Stream)
connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins cvqkd_alice_axi_wrapper_0/s_axis_x]
connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins cvqkd_alice_axi_wrapper_0/s_axis_m]

# DMAs Lectores -> Interconnect -> HP0 DDR
...
# 13. Conexiones de Reloj y Resets
connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] \
  ...
  [get_bd_pins cvqkd_alice_axi_wrapper_0/aclk]
...
connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] \
  ...
  [get_bd_pins cvqkd_alice_axi_wrapper_0/aresetn]
...
# 14. Asignación del Mapa de Direcciones (Address Mapping)
assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cvqkd_alice_axi_wrapper_0/s_axi/reg0] -force
...
# 15. Validación y Guardado del Diseño
validate_bd_design
save_bd_design

# 16. Generar Top HDL Wrapper y establecer como Top
set wrapper_file [make_wrapper -files [get_files design_1.bd] -top]
add_files -norecurse $wrapper_file
set_property top design_1_wrapper [current_fileset]
update_compile_order -fileset sources_1

# 17. Generar los productos de síntesis/implementación del BD
generate_target all [get_files design_1.bd]

puts {=== [OK] Block Design design_1 y Wrapper HDL generados con EXITO ===}
